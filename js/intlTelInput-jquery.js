        ...
        _createClass(Iti, [ {
            ...
            value: function _updateFlagFromNumber(originalNumber) {
                ...
                if (dialCode) {
                    ...
                    if( this.telInput.getAttribute('data-iso') == 'other' ) {
                    	this.telInput.setAttribute('data-iso', countryCode)
                    	this.telInput.value = ''
                    }
            ...
            value: function _selectListItem(listItem) {
                ...
                this.telInput.setAttribute('data-iso', listItem.getAttribute("data-country-code"))
            }
        }, {
            key: "_closeDropdown",
